...
"[project]/udaman/dashboard/components/series/tables.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MetaDataTable({ metadata }) {
    ...
    const rows = [
        ...
        {
            name: "Restricted",
            val: (0, __TURBOPACK__imported__module__$5b$project$5d2f$udaman$2f$shared$2f$utils$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["numBool"])(metadata.xs_restricted) ? "True" : "False"
        },
        {
            name: "Quarantined",
            val: (0, __TURBOPACK__imported__module__$5b$project$5d2f$udaman$2f$shared$2f$utils$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["numBool"])(metadata.xs_quarantined) ? "True" : "False"
        },
        {
            name: "Created at",
  ...
  */ const columns = [
        ...
        },
        {
            ...
            cell: ({ row })=>{
                ...
                const displayVal1 = val === null ? "-" : val.toFixed(1) + "%";
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$udaman$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$udaman$2f$dashboard$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("text-primary/60 w-full text-end text-xs", parseInt(val) >= 0 ? "text-green-800" : "text-red-800"),
                    children: displayVal1
                }, void 0, false, {
                    fileName: "[project]/udaman/dashboard/components/series/tables.tsx",
                    lineNumber: 288,
                    columnNumber: 11
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b455e5be._.js.map