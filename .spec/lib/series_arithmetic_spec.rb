...
describe SeriesArithmetic do
  ...
  describe "performing series ARITHMETIC" do
    ...
    xit "should raise a SeriesArithmeticException when you try to two series with different units" do
      lambda {@dollars_series + @people_series}.should raise_error SeriesArithmeticException
    end
  
    xit "should raise a SeriesArithmeticException when you try to subtract two series with different units" do
      lambda {@dollars_series - @people_series}.should raise_error SeriesArithmeticException
    end
  
    xit "should raise a SeriesArithmeticException when a series tests the arithmetic validity of a series with a different frequency" do
    ...
    xit "should raise a SeriesArithmeticException when a series tests the arithmetic validity of another series and at least one does not have a frequency defined" do
    ...
    xit "should fill in a series with 0s for all null values if +_ is used" do
  ...
  describe "ROUNDING series values" do
    xit "should round all values in a series to 0 decimal places" do
  ...
  describe "calculating an ANNUAL SUM" do
    xit "should successfully calculate an annual sum" do
      annual_sum  = @dh.ns "ANNUAL_SUM@TEST.M"
      to_mov_avg  = @dh.ns "TO_AVG@TEST.M"
      annual_sum.identical_to?(to_mov_avg.annual_sum.data).should be_true
    end
    
    xit "should successfully calculate an annual sum at quarterly frequency" do
  ...
  describe "calculating a ANNUAL AVERAGE" do
    xit "should succesfully calculate an annual average" do
  ...
  describe "calculating a MOVING AVERAGE" do
    ...
    xit "should successfully calculate a moving average" do
       to_mov_avg  = @dh.ns "TO_AVG@TEST.M"
  ...
  describe "calculating PERCENTAGE CHANGE" do
    ...
    xit "should successfully calculate percentage change" do
      per_change = @dh.ns "PER_CHANGE@TEST.M"
      to_mov_avg  = @dh.ns "TO_AVG@TEST.M"
      per_change.identical_to?(to_mov_avg.percentage_change.data).should be_true
    end
    
    xit "should successfully calculate annualized percentage change" do
  ...
  describe "REBASING series to a particular date" do
    xit "should successfully rebase a series to the value at a particular date" do
      data_q  = @dh.ns "DATA@TEST.Q"
