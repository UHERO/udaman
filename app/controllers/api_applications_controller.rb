class ApiApplicationsController < ApplicationController
  ...
  before_action :set_api_application, only: %i[show edit update destroy]
  ...
  def create
    ...
    if @api_application.save
      redirect_to(
        api_application_path(@api_application),
        notice: "Api application was successfully created."
      )
    else
      render :new
    end
  ...
  def update
    if @api_application.update(api_application_params)
      redirect_to(
        api_application_path(@api_application),
        notice: "Api application was successfully updated."
      )
    else
      render :edit
    end
  ...
  def destroy
    ...
    redirect_to(
      ...
      notice: "Api application was successfully destroyed."
    )
  end
  ...
  def api_application_params
    params.require(:api_application).permit(
      :name,
      :hostname,
      :api_key,
      :github_nickname
