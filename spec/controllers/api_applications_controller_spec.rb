...
RSpec.describe ApiApplicationsController, type: :controller do
  ...
  # ApiApplicationsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested api_application as @api_application" do
      api_application = ApiApplication.create! valid_attributes
      get :show, params: {id: api_application.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested api_application as @api_application" do
      api_application = ApiApplication.create! valid_attributes
      get :edit, params: {id: api_application.to_param}, session: valid_session
      expect(assigns(:api_application)).to eq(api_application)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new ApiApplication" do
        expect {
          post :create, params: {api_application: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved api_application as @api_application" do
        post :create, params: {api_application: invalid_attributes}, session: valid_session
        expect(assigns(:api_application)).to be_a_new(ApiApplication)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested api_application" do
        api_application = ApiApplication.create! valid_attributes
        put :update, params: {id: api_application.to_param, api_application: new_attributes}, session: valid_session
      ...
      it "assigns the requested api_application as @api_application" do
        api_application = ApiApplication.create! valid_attributes
        put :update, params: {id: api_application.to_param, api_application: valid_attributes}, session: valid_session
        expect(assigns(:api_application)).to eq(api_application)
      end
    ...
    context "with invalid params" do
      it "assigns the api_application as @api_application" do
        api_application = ApiApplication.create! valid_attributes
        put :update, params: {id: api_application.to_param, api_application: invalid_attributes}, session: valid_session
        expect(assigns(:api_application)).to eq(api_application)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested api_application" do
      api_application = ApiApplication.create! valid_attributes
      expect {
        delete :destroy, params: {id: api_application.to_param}, session: valid_session
      }.to change(ApiApplication, :count).by(-1)
    end
