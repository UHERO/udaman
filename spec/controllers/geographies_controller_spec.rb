...
RSpec.describe GeographiesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested geography as @geography" do
      geography = Geography.create! valid_attributes
      get :show, {:id => geography.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested geography as @geography" do
      geography = Geography.create! valid_attributes
      get :edit, {:id => geography.to_param}, valid_session
      expect(assigns(:geography)).to eq(geography)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Geography" do
        expect {
          post :create, {:geography => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved geography as @geography" do
        post :create, {:geography => invalid_attributes}, valid_session
        expect(assigns(:geography)).to be_a_new(Geography)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested geography" do
        geography = Geography.create! valid_attributes
        put :update, {:id => geography.to_param, :geography => new_attributes}, valid_session
        geography.reload
      ...
      it "assigns the requested geography as @geography" do
        geography = Geography.create! valid_attributes
        put :update, {:id => geography.to_param, :geography => valid_attributes}, valid_session
        expect(assigns(:geography)).to eq(geography)
      end
    ...
    context "with invalid params" do
      it "assigns the geography as @geography" do
        geography = Geography.create! valid_attributes
        put :update, {:id => geography.to_param, :geography => invalid_attributes}, valid_session
        expect(assigns(:geography)).to eq(geography)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested geography" do
      geography = Geography.create! valid_attributes
      expect {
        delete :destroy, {:id => geography.to_param}, valid_session
      }.to change(Geography, :count).by(-1)
    end
