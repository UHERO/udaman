...
describe PrognozDataFile do
  describe "LOADING DATA from FILE" do
    ...
    xit "should populate series loaded with frequency codes" do
      @visns_output_file.load
      @visns_output_file.series_loaded.keys[0].should == "VISNS@HI.M"
    end

    xit "should populate frequency" do
      @visns_output_file.load
  ...
  describe "RETRIEVING series data" do
    ...
    xit "should return a data hash with datestrings as keys if series is present in PrognozDataFile object and in updatespreadsheet"do
    ...
    xit "should retrieve series data given the name of a series present and no update_spreadsheet object" do
  ...
  describe "OUTPUTTING series data" do
    ...
    xit "should produce output dates from starting date to current date" do
    ...
    xit "should create a output file" do
