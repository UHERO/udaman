...
describe BlsTextParser do
  ...
  # end
  xit "should read all data rows into a hash with the series code as the key" do
  ...
  xit "should create a hash with monthly data if available as value for each code key" do
    btp = BlsTextParser.new("spec/datafiles/specs/blstextfile.txt")
    data_hash = btp.get_data_hash
  ...
  xit "should create a hash with annual data if available as value for each code key" do
    btp = BlsTextParser.new("spec/datafiles/specs/blstextfile.txt")
    data_hash = btp.get_data_hash
  ...
  xit "should create a hash with quarterly data if available as value for each code key" do
    btp = BlsTextParser.new("spec/datafiles/specs/blstextfile.txt")
    data_hash = btp.get_data_hash
