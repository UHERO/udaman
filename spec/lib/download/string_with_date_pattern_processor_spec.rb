...
describe Downloaders::StringWithDatePatternProcessor do    
  it "should compute a single date element pattern correctly" do
    swdpp = Downloaders::StringWithDatePatternProcessor.new("BLS_HIWI%Y.XLS")
  ...
  it "should compute a two date element pattern correctly" do
    swdpp = Downloaders::StringWithDatePatternProcessor.new("Tour_%b%y.XLS")
  ...
  it "should compute a three date element pattern correctly" do
    swdpp = Downloaders::StringWithDatePatternProcessor.new("Tax_%b%y/%mcollec.XLS")
