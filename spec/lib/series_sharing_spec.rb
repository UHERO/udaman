...
describe SeriesSharing do
  ...
  describe "perform COMPOSITE, MEAN CORRECTION, AND SHARING series transformations" do
    xit "should calculate county series by calculating shares of county values over the sum of counties" do
    ...
    xit "should load a seasonally adjusted series and do annual mean correction in one step" do
      Series.load_all_series_from "#{ENV["DATAFILES_PATH"]}/datafiles/specs/ECT.xls"
    ...
    xit "should calculate county series by calculating county value over the state value and mean correcting annually" do
      Series.load_all_series_from "#{ENV["DATAFILES_PATH"]}/datafiles/specs/ECT.xls"
