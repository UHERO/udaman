...
export const processors: Record<string, (job: Job) => Promise<string>> = {
  ...
  [JobName.RELOAD_BLS]: processTargetedReload,
  [JobName.RELOAD_BEA]: processTargetedReload,
  [JobName.RELOAD_TOUR_OCUP]: processTargetedReload,
  [JobName.RELOAD_SA]: processTargetedReload,
  [JobName.RELOAD_VAP_HI]: processTargetedReload,
  [JobName.RELOAD_UIC]: processTargetedReload,
