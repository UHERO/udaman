...
export class HhdbCurrentTaxBill {
  ...
  constructor(attrs: HhdbCurrentTaxBillAttrs) {
    ...
    this.originalDueDate = attrs.original_due_date
      ? new Date(attrs.original_due_date)
      : null;
    this.taxesAssessment =
      attrs.taxes_assessment != null ? Number(attrs.taxes_assessment) : null;
    this.taxCredits =
      attrs.tax_credits != null ? Number(attrs.tax_credits) : null;
...
export function hhdbCurrentTaxBillRowToJSON(
  attrs: HhdbCurrentTaxBillAttrs,
): HhdbCurrentTaxBillJSON {
  return {
    ...
    originalDueDate: attrs.original_due_date
      ? new Date(attrs.original_due_date).toISOString()
      : null,
    taxesAssessment:
      attrs.taxes_assessment != null ? Number(attrs.taxes_assessment) : null,
