  ...
  if (!config.fieldsTable) {
    return (
      <p className="text-muted-foreground text-sm">
        No range data available for this table.
      </p>
    );
  }

  const basePath = `/udaman/${universe}/hhdb/tables/${table}/range`;
  return <HhdbSummaries tableName={config.fieldsTable} basePath={basePath} viewType="range" />;
}
