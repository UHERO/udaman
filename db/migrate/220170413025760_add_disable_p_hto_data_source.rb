class AddDisablePHtoDataSource < ActiveRecord::Migration[5.2]
  def change
    add_column :data_sources, :disabled, :boolean, null: false, default: false, after: :reload_nightly
    add_column :data_sources, :pseudo_history, :boolean, null: false, default: false, after: :reload_nightly
