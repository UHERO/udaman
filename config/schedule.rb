...
every 1.day, :at => '6:00 am' do
  ## Note that these tasks take a long time to appear in sidekiq because of the very
  ## long time needed to gather up their series in Series.get_all_series_by_eval
