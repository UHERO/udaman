...
Rails.application.routes.draw do
  ...
  resources :measurements do
    member do
      get 'duplicate'
      get 'add_series/:series_id', to: 'measurements#add_series', as: 'add_series'
      get 'edit_as_text'
      patch 'save_as_text'
      post 'import_clip'
      post 'add_clip'
  ...
  resources :series do
    collection do
      ...
      get 'quarantine'
      get 'empty_quarantine'  # Add this line
      get 'meta_update'
      post 'meta_store'
      get 'clip', to: 'series#clipboard'
      get 'add_clip'
      get 'clear_clip'
      post 'do_clip_action'  # Fix this line
      get 'autocomplete_search'
      get 'group_export'
      get 'new_search'
      get 'csv2tsd_upload'
      post 'csv2tsd'
      get 'transform'  # Add this line
    end
