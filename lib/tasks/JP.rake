...
task :jp_upd_a => :environment do
  t = Time.now
	...
	p.write_definitions_to "#{ENV['DATA_PATH']}/japan/update/jp_upd_a_NEW.xls"
...
p.write_definitions_to "#{ENV['DATA_PATH']}/japan/update/jp_upd_q_NEW.xls"
...
task :jp_upd_m => :environment do
  t = Time.now
	...
	p.write_definitions_to "#{ENV['DATA_PATH']}/japan/update/jp_upd_m_NEW.xls"

	p = Packager.new
	p.add_definitions jp_m_special
	p.write_definitions_to "#{ENV['DATA_PATH']}/japan/update/jp_upd_m2_NEW.xls"
