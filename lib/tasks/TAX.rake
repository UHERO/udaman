...
task :tax_upd => :environment do
  t = Time.now
	...
	Series.load_all_series_from "#{ENV['DATA_PATH']}/rawdata/Manual/dotax_preliminary_data.xls"
	
	p = Packager.new
	p.add_definitions collec
	p.write_definitions_to "#{ENV['DATA_PATH']}/tax/update/collec_upd_NEW.xls"

  p = Packager.new
  p.add_definitions ge
  p.write_definitions_to "#{ENV['DATA_PATH']}/tax/update/ge_upd_NEW.xls"
...
task :tax_identities => :environment do
  ...
  "TR@HI.M".ts_eval=%Q|"TR@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TR@HI.M".ts_eval=%Q|"TR@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TRFU@HI.M".ts_eval=%Q|"TRFU@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TRFU@HI.M".ts_eval=%Q|"TRFU@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TRGT@HI.M".ts_eval=%Q|"TRGT@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TRGT@HI.M".ts_eval=%Q|"TRGT@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TRCOES@HI.M".ts_eval=%Q|"TRCOES@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TRCOES@HI.M".ts_eval=%Q|"TRCOES@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TRCOPR@HI.M".ts_eval=%Q|"TRCOPR@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TRCOPR@HI.M".ts_eval=%Q|"TRCOPR@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TRCORF@HI.M".ts_eval=%Q|"TRCORF@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TRCORF@HI.M".ts_eval=%Q|"TRCORF@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TRINES@HI.M".ts_eval=%Q|"TRINES@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TRINES@HI.M".ts_eval=%Q|"TRINES@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TRINPR@HI.M".ts_eval=%Q|"TRINPR@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TRINPR@HI.M".ts_eval=%Q|"TRINPR@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TRINWH@HI.M".ts_eval=%Q|"TRINWH@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TRINWH@HI.M".ts_eval=%Q|"TRINWH@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TRINRF@HI.M".ts_eval=%Q|"TRINRF@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TRINRF@HI.M".ts_eval=%Q|"TRINRF@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TRTT@HI.M".ts_eval=%Q|"TRTT@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TRTT@HI.M".ts_eval=%Q|"TRTT@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim("1987-02-01","1987-12-01")|
  "TRTT@HI.M".ts_eval=%Q|"TRTT@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TGR@HI.M".ts_eval=%Q|"TGR@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TGR@HI.M".ts_eval=%Q|"TGR@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TGRRT@HI.M".ts_eval=%Q|"TGRRT@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TGRRT@HI.M".ts_eval=%Q|"TGRRT@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TGRCT@HI.M".ts_eval=%Q|"TGRCT@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TGRCT@HI.M".ts_eval=%Q|"TGRCT@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TGRHT@HI.M".ts_eval=%Q|"TGRHT@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TGRHT@HI.M".ts_eval=%Q|"TGRHT@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TGB@HI.M".ts_eval=%Q|"TGB@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TGB@HI.M".ts_eval=%Q| "TGB@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TGBRT@HI.M".ts_eval=%Q|"TGBRT@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TGBRT@HI.M".ts_eval=%Q|"TGBRT@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TGBSV@HI.M".ts_eval=%Q|"TGBSV@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TGBSV@HI.M".ts_eval=%Q|"TGBSV@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TGBCT@HI.M".ts_eval=%Q|"TGBCT@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TGBCT@HI.M".ts_eval=%Q|"TGBCT@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  ...
  "TGBHT@HI.M".ts_eval=%Q|"TGBHT@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TGBHT@HI.M".ts_eval=%Q|"TGBHT@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TDGF@HI.M".ts_eval=%Q|"TDGF@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TDGF@HI.M".ts_eval=%Q|"TDGF@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TDHW@HI.M".ts_eval=%Q|"TDHW@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TDHW@HI.M".ts_eval=%Q|"TDHW@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TDAP@HI.M".ts_eval=%Q|"TDAP@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TDAP@HI.M".ts_eval=%Q|"TDAP@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TDTS@HI.M".ts_eval=%Q|"TDTS@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TDTS@HI.M".ts_eval=%Q|"TDTS@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TDCT@HI.M".ts_eval=%Q|"TDCT@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TDCT@HI.M".ts_eval=%Q|"TDCT@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TDCTFU@HI.M".ts_eval=%Q|"TDCTFU@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TDCTFU@HI.M".ts_eval=%Q|"TDCTFU@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TDCTTT@HI.M".ts_eval=%Q|"TDCTTT@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TDCTTT@HI.M".ts_eval=%Q|"TDCTTT@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim("1990-08-01","1990-12-01")|
  "TDCTTT@HI.M".ts_eval=%Q|"TDCTTT@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TGRSV@HI.M".ts_eval=%Q|"TGRSV@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TGRSV@HI.M".ts_eval=%Q|"TGRSV@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TRCO@HI.M".ts_eval=%Q|"TRCO@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TRCO@HI.M".ts_eval=%Q|"TRCO@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
  "TRIN@HI.M".ts_eval=%Q|"TRIN@HI.M".tsn.load_sa_from("#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata").trim|
  "TRIN@HI.M".ts_eval=%Q|"TRIN@HI.M".tsn.load_mean_corrected_sa_from "#{ENV['DATA_PATH']}/tax/seasadj/sadata.xls", "sadata"|
